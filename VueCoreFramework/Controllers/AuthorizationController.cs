...
namespace VueCoreFramework.Controllers
{
    ...
    public class AuthorizationController : Controller
    {
        ...
        public async Task<IActionResult> InviteUserToGroup(string username, string group)
        {
            ...
            var acceptCallbackUrl = Url.Action(nameof(AuthorizationController.AddUserToGroup), "Authorization", new { userId = targetUser.Id, groupId = groupRole.Id, code = confirmCode }, protocol: HttpContext.Request.Scheme);
