...
{
    public partial class InitialSampleDbMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastEmailChange = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EpiIndex = table.Column<double>(type: "float", nullable: true),
                    FlagPrimaryColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(125)", maxLength: 125, nullable: true),
                    GroupRecipientId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    GroupRecipientName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    SingleRecipientId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    SingleRecipientName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CountryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsCapitol = table.Column<bool>(type: "bit", nullable: false),
                    LocalTimeAtGMTMidnight = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TimeInOfficeTicks = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
