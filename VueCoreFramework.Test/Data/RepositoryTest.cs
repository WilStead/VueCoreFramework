...
namespace VueCoreFramework.Test.Data
{
    ...
    public class RepositoryTest
    {
        ...
        public async Task AddAsync_WithNavProp()
        {
            ...
            await repo.AddAsync(childProp, Guid.Empty);
        ...
        public async Task AddChildrenToCollectionAsyncTest()
        {
            ...
            await parentRepo.AddChildrenToCollectionAsync(parent.Id, childProp, new Guid[] { child.Id });
        ...
        public async Task FindAsync_ItemPresent()
        {
            ...
            var vm = await repo.FindAsync(item.Id);
        ...
        public async Task FindAsync_ItemNotPresent()
        {
            ...
            var vm = await repo.FindAsync(Guid.Empty);
            Assert.IsTrue(vm.Keys.Contains(nameof(DataItem.Id).ToInitialLower()));
        ...
        public async Task FindItemAsync_ItemPresent()
        {
            ...
            var found = await repo.FindItemAsync(item.Id);
        ...
        public async Task FindItemAsync_ItemNotPresent()
        {
            ...
            var item = await repo.FindItemAsync(Guid.Empty);
            Assert.IsNull(item);
        }
        ...
        public async Task GetAll_NoItemsPresent()
        {
            ...
            await repo.RemoveRangeAsync(context.Countries.Select(c => c.Id));
            var vms = repo.GetAll();
        ...
        public async Task GetChildIdAsyncTest()
        {
            ...
            var vm = await childRepo.AddAsync(childProp, parent.Id);
            var childId = vm[nameof(DataItem.Id).ToInitialLower()];

            var id = await parentRepo.GetChildIdAsync(parent.Id, parentProp);
            Assert.AreEqual(childId, id.ToString());
        }
        ...
        public async Task GetChildTotalAsyncTest()
        {
            ...
            await childRepo.AddAsync(childProp, parent.Id);

            var total = await parentRepo.GetChildTotalAsync(parent.Id, parentProp);
        ...
        public async Task GetPage_ItemsPresent()
        {
            ...
            var vms = repo.GetPage(null, null, false, 1, 5, new Guid[] { },
        ...
        public async Task RemoveChildrenFromCollectionAsyncTest()
        {
            ...
            await parentRepo.RemoveChildrenFromCollectionAsync(parent.Id, childProp, new Guid[] { child.Id });
        ...
        public async Task RemoveFromParentAsyncTest()
        {
            ...
            var removed = await repo.RemoveFromParentAsync(item.Id, childProp);
        ...
        public async Task RemoveRangeFromParentAsyncTest()
        {
            ...
            var removedIds = await repo.RemoveRangeFromParentAsync(context.Cities.Select(c => c.Id), childProp);
            var newCount = context.Cities.Count();
        ...
        public async Task ReplaceChildAsyncTest()
        {
            ...
            var oldId = await childRepo.ReplaceChildAsync(parent.Id, newChild.Id, childProp);
            var newCount = context.Cities.Count();
            Assert.IsTrue(oldId.HasValue);
            Assert.AreEqual(count - 1, newCount);
        }
        ...
        public async Task ReplaceChildWithNewAsyncTest()
        {
            ...
            var (vm, oldId) = await childRepo.ReplaceChildWithNewAsync(parent.Id, childProp);
            var newCount = context.Cities.Count();
            Assert.IsTrue(oldId.HasValue);
