...
{
    /// <summary>
    /// The API controller for handling data manipulation tasks.
    /// </summary>
    [Authorize]
    ...
    public class DataController : Controller
    {
        ...
        public async Task<IActionResult> Add(string dataType, string childProp, string parentId, [FromHeader(Name = "Accept-Language")]string culture)
        {
            ...
            if (Authorization.GetAuthorization(claims, dataType, CustomClaimTypes.PermissionDataAdd) == Authorization.unauthorized)
            {
        ...
        public async Task<IActionResult> AddChildrenToCollection(string dataType, string id, string childProp, [FromBody]string[] childIds)
        {
            ...
            if (Authorization.GetAuthorization(claims, dataType, CustomClaimTypes.PermissionDataEdit, id) == Authorization.unauthorized)
            {
        ...
        public async Task<IActionResult> Duplicate(string dataType, string id, [FromHeader(Name = "Accept-Language")]string culture)
        {
            ...
            if (Authorization.GetAuthorization(claims, dataType, CustomClaimTypes.PermissionDataAdd, id) == Authorization.unauthorized)
            {
                return StatusCode(403, _errorLocalizer[ErrorMessages.NoPermission, _errorLocalizer[ErrorMessages.PermissionAction_AddNew]]);
            }
            object newItem = null;
        ...
        public async Task<IActionResult> Find(string dataType, string id, [FromHeader(Name = "Accept-Language")]string culture)
        {
            ...
            if (Authorization.GetAuthorization(claims, dataType, CustomClaimTypes.PermissionDataView, id) == Authorization.unauthorized)
            {
        ...
        public async Task<IActionResult> GetAll(string dataType, [FromHeader(Name = "Accept-Language")]string culture)
        {
            ...
            if (Authorization.GetAuthorization(claims, dataType, CustomClaimTypes.PermissionDataView) == Authorization.unauthorized)
            {
            ...
            [FromHeader(Name = "Accept-Language")]string culture)
        {
            ...
            if (Authorization.GetAuthorization(claims, childType.Name, CustomClaimTypes.PermissionDataView) == Authorization.unauthorized)
            {
                return StatusCode(403, _errorLocalizer[ErrorMessages.NoPermission, _errorLocalizer[ErrorMessages.PermissionAction_ViewItems]]);
            }
            try
        ...
        public async Task<IActionResult> Remove(string dataType, string id)
        {
            ...
            if (Authorization.GetAuthorization(claims, dataType, CustomClaimTypes.PermissionDataAll, id) == Authorization.unauthorized)
            {
        ...
        public async Task<IActionResult> ReplaceChild(string dataType, string parentId, string newChildId, string childProp)
        {
            ...
            if (Authorization.GetAuthorization(claims, dataType, CustomClaimTypes.PermissionDataEdit, parentId) == Authorization.unauthorized)
            {
                return StatusCode(403, _errorLocalizer[ErrorMessages.NoPermission, _errorLocalizer[ErrorMessages.PermissionAction_EditItem]]);
            }
            try
